...
const startServer = async () => {
  ...
  const authExecutor = createExecutor('http://localhost:4001/graphql');
  const productExecutor = createExecutor('http://localhost:4002/graphql');
  const orderExecutor = createExecutor('http://localhost:4003/graphql');
  ...
  try {
    ...
    app.listen(PORT, () => {
      ...
      console.log(`   - Product Service: http://localhost:4002/graphql`);
      console.log(`   - Order Service: http://localhost:4003/graphql`);
